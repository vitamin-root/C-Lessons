    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           */
            ...
            // Вариант 1 поэлементное копирование
            // через определение размера методом GetLength
            
            int[,] copy_mas = new int[row, col];
            ...
            ////Вариант 2 поэлементное копирование
            // по размерам массива
            //for (int i = 0; i < row; i++)
            //{
            //    for (int j = 0; j < col; j++)
            ...
            Array.Copy(mas, copy2, copy2.Length);
            ...
            mas[1, 2] = 5000;// эти изменения не отражаются на копии
            Console.WriteLine("\nКопия массива: ");
